...
export default withLineItemProvider(function Home({
  ...
  const placeholder = {
    url: "//cdn.logo.com/hotlink-ok/enterprise/eid_422203f0-477b-492b-9847-689feab1452a/logo-dark-2020.png",
  };
  ...
  return (
    <div>
      ...
      <main
        data-theme={paper ? "light" : undefined}
        className="flex items-center justify-center not-print:pt-16 not-print:pb-4 not-print:relative"
      >
        {paper && <p className="text-gray-500 position absolute top-8 text-sm">Print Preview</p>}{" "}
        {/** this absolute positioning is a mess. See line 78 */}
        <div className="not-print:max-w-[8.3in] not-print:container mx-auto shadow-xl min-h-screen dark:bg-gray-950 bg-gray-50 text-gray-800 dark:text-white p-8 print:text-xs print:absolute print:z-50 print:top-0 print:w-full">
          <div className="grid grid-cols-6 gap-4 p-2">
            <div className="col-span-6 md:col-span-3 print:col-span-3">
              <Autosave
                onChange={(logo) => setLogo(logo as unknown as { url: string })}
                name="logo"
              >
                <ImageInput
                ...
                <Container>
                  ...
                  <div className="flex items-center">
                    <p className="font-bold px-2 whitespace-nowrap">
                      <HelpTooltip tooltip="The legal date of this invoice being served">
                        Tax Date
                      </HelpTooltip>
                    </p>
                    <DateInput
                      data-testid="tax-date"
                      name="taxDate"
                      className="w-full"
                      value={date}
                      onChange={setDate}
                  ...
                  <div className="flex items-center">
                    <p className="font-bold px-2 whitespace-nowrap">
                      <HelpTooltip tooltip="If you weren't given a purchase order, leave this blank">
                        PO / Reference
                      </HelpTooltip>
                    </p>
                    <TextInput
            ...
            <div className={`col-span-6 md:col-span-3 print:col-span-3`}>
              <Autosave
                onChange={(from) => setFrom(from as unknown as Address)}
                name="from-address"
              >
            ...
            <div className="col-span-6 md:col-span-4 print:col-span-4">
              <Autosave
                onChange={(payment) => setPayment(payment as unknown as PaymentDetails)}
                ...
                <Container>
                  ...
                  <div className="p-2">
                    ...
                    <StandardField
                      ...
                      {...fieldFormattingOf("sortCode")}
                    />
                    <StandardField
                      name="number"
                      title="Acc. Number"
                      defaultValue={payment.number}
                      {...fieldFormattingOf("accountNumber")}
                    />
                    <StandardField
                      name="bankName"
                      title="Bank Name"
                    ...
                    <StandardField
                      name="emailAddress"
                      title="Contact Email"
                      defaultValue={payment.emailAddress}
                    />
                    <StandardField
                      name="phoneNumber"
                      title="Contact Number"
                      defaultValue={payment.phoneNumber}
                    />
                    <StandardField
                      name="info"
...
const PreviewOptions = ({
  ...
  paper: boolean;
  setPaper: React.Dispatch<React.SetStateAction<boolean>>;
}) => (
  <button
    className={
