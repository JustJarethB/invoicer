...
const getStageContent = ({
  ...
  switch (stage) {
    case 0:
      return (
        <Modal title="Need a hand?" onClose={finishTutorial}>
          <div className="flex flex-col gap-4">
            <p className="text-gray-700 dark:text-gray-300">
              Welcome to the app! If you need help getting started, we can guide you through the
              basics.
            </p>
            <p className="text-xs text-gray-700 dark:text-gray-300">
              We won't ask again, but you can always change your mind in the settings!
            </p>
            <ButtonBar>
              <Button color="info" onClick={nextStage}>
                Start Tutorial
              </Button>
              <Button onClick={finishTutorial}>Maybe later</Button>
            </ButtonBar>
          </div>
        </Modal>
      );
    case 1:
      return (
        <Modal title="Great choice!" onClose={closeTutorial}>
          <div className="flex flex-col gap-4">
            <p className="text-gray-700 dark:text-gray-300">
              We'll only take a minute to show you the need-to-knows of the app; The ethos of this
              project is to get you on the ground and running without the bloat. You can use your
              keyboard to navigate the tutorial, you'll see why that's good to know in a moment...
            </p>
            <ButtonBar>
              <Button color="info" onClick={nextStage}>
                Next
    ...
    default:
      return (
        <Modal title="We're Lost!" onClose={closeTutorial}>
          <div className="">
            <p className="text-gray-700 dark:text-gray-300">
              This is embarassing, but you shouldn't be able to see this. It looks like you've been
              sent down the wrong path. Please try again, and let us know if this keeps happening!
            </p>
            <ButtonBar>
              <Button color="danger" onClick={closeTutorial}>
                Abort Tutorial
              </Button>
            </ButtonBar>
          </div>
